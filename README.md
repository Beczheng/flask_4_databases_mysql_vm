...
- Database schema
  1. For the database, I created a two tables: doctors and licenses. In my doctors table, I included the following columns: doctord_id, first_name, and last_name. In my licenses table: I included the following columns: license_id, doctor_id, license_number, issue_date, and expiration_date. I kept the tables the same for both Azure and GCP.
- Errors
